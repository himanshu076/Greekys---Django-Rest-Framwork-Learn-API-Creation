"""Class_Based_View_Part2 URL Configuration
...
urlpatterns = [
    ...
    path('newsfun/', views.newsfun, {'template':'school/news.html'}, name='newsfun'),
    path('newsfun2/', views.newsfun, {'template':'school/news2.html'}, name='newsfun2'),

    # path('newscl/', views.NewsClassView.as_view(), name='newscl'),
    path('newscl/', views.NewsClassView.as_view(template='school/news.html'), name='newscl'),
    path('newscl2/', views.NewsClassView.as_view(template='school/news2.html'), name='newscl2'),
]
